...
/**
 * Developer-controlled Tailwind extensions for the Fitness template.
 *
 * Theme Manager values belong in src/theme.config.ts. This file keeps only
 * non-marketer-editable project extensions such as animations and a custom
 * breakpoint/scale/container behaviour.
 */
