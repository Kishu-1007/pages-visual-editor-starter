...
import { FitnessProofTemplateConfig } from "../registry/FitnessProofTemplate/config";
...
const FitnessProofTemplate: Template<TemplateRenderProps> = (props) => {
    const { document } = props;
    ...
    return (
        ...
        >
            <VisualEditorProvider templateProps={props}>
                <GTMBody>
                    <VisualEditorRender
                        config={FitnessProofTemplateConfig}
                        data={data}
...
export default FitnessProofTemplate;
